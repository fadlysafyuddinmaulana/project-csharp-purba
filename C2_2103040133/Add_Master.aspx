<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true"
    CodeBehind="Add_Master.aspx.cs" Inherits="C2_2103040133.Add_Master" %>
            ...
            <tr>
                ...
                <td>
                    <asp:DropDownList ID="DropDownList1" runat="server"
                        DataTextField="jenis_buku" DataValueField="id_jenis" 
                        DataSourceID="SqlDataSource1">
                    </asp:DropDownList>
                    <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
                        ConnectionString="<%$ ConnectionStrings:db_toko_bukuConnectionString %>" 
                        SelectCommand="SELECT * FROM [tb_jenis_buku]"></asp:SqlDataSource>
                </td>
            </tr>
            <tr>
                <td class="style2">
                ...
                <td>
                    ...
                    <asp:SqlDataSource ID="SqlDataSource2" runat="server" 
                        ConnectionString="<%$ ConnectionStrings:db_toko_bukuConnectionString %>" 
                        SelectCommand="SELECT * FROM [tb_kategori]"></asp:SqlDataSource>
                </td>
            </tr>
            <tr>
                <td class="style2">
