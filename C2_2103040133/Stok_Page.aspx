<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true"
    CodeBehind="Stok_Page.aspx.cs" Inherits="C2_2103040133.Invoice" %>
            ...
            <tr>
                ...
                <td>
                    <asp:DropDownList ID="DropDownList2" runat="server" DataSourceID="SqlDataSource2"
                        DataTextField="nomor_buku" DataValueField="nomor_buku">
                    </asp:DropDownList>
                    <asp:SqlDataSource ID="SqlDataSource2" runat="server" ConnectionString="<%$ ConnectionStrings:db_toko_bukuConnectionString %>"
                        SelectCommand="SELECT [nomor_buku] FROM [tb_buku]"></asp:SqlDataSource>
                </td>
            </tr>
            <tr>
                <td class="style2">
